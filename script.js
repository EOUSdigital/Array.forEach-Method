...
//      SET lengths TO an strings.map(str => str.length)
//       return lengths
...
//  SET users [ { firstName, lastName } ]

//  SET fullNames equal TO users.map user equal or greater to `${user.firstName} ${user.lastName}`
//  PRINT fullNames
...
const users = [
    { firstName: "Amelia", lastName: "Blythe" },
    { firstName: "Noah", lastName: "Arden" },
    { firstName: "Eleanor", lastName: "Willow" },
];
